...
Removal of the 4-way interaction and the least significant 3-way interaction does not lead to a significant difference between the full and reduced models at the 0.05 level, but we will not remove any terms.

```{r}
fit.area <- update(fit.area, method = "REML")
VarCorr(fit.area)
```
