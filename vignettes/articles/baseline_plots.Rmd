...
ggsave("../../plots/baseline_NMR_body_mass_6M_female.pdf",
...
ggsave("../../plots/baseline_NMR_body_mass_6M_male.pdf",
       height = 1.8, width = 1.1, family = "ArialMT")
```
...
ggsave("../../plots/baseline_NMR_body_mass_18M_female.pdf",
       height = 1.8, width = 1.1, family = "ArialMT")
```
...
ggsave("../../plots/baseline_NMR_body_mass_18M_male.pdf",
       height = 1.8, width = 1.1, family = "ArialMT")
```
...
ggsave("../../plots/baseline_NMR_lean_6M_female.pdf",
       height = 1.8, width = 1.1, family = "ArialMT")
```
...
ggsave("../../plots/baseline_NMR_lean_6M_male.pdf",
       height = 1.8, width = 1.1, family = "ArialMT")
```
...
ggsave("../../plots/baseline_NMR_lean_18M_female.pdf",
       height = 1.8, width = 1.1, family = "ArialMT")
```
...
ggsave("../../plots/baseline_NMR_lean_18M_male.pdf",
       height = 1.8, width = 1.1, family = "ArialMT")
```
...
ggsave("../../plots/baseline_NMR_fat_6M_female.pdf",
       height = 1.8, width = 1.1, family = "ArialMT")
```
...
ggsave("../../plots/baseline_NMR_fat_6M_male.pdf",
       height = 1.8, width = 1.1, family = "ArialMT")
```
...
ggsave("../../plots/baseline_NMR_fat_18M_female.pdf",
       height = 1.8, width = 1.1, family = "ArialMT")
```
...
ggsave("../../plots/baseline_NMR_fat_18M_male.pdf",
       height = 1.8, width = 1.1, family = "ArialMT")
```
...
ggsave("../../plots/baseline_NMR_pct_lean_6M_female.pdf",
       height = 1.8, width = 1.1, family = "ArialMT")
```
...
ggsave("../../plots/baseline_NMR_pct_lean_6M_male.pdf",
       height = 1.8, width = 1.1, family = "ArialMT")
```
...
ggsave("../../plots/baseline_NMR_pct_lean_18M_female.pdf",
       height = 1.8, width = 1.1, family = "ArialMT")
```
...
ggsave("../../plots/baseline_NMR_pct_lean_18M_male.pdf",
       height = 1.8, width = 1.1, family = "ArialMT")
```
...
ggsave("../../plots/baseline_NMR_pct_fat_6M_female.pdf",
       height = 1.8, width = 1.1, family = "ArialMT")
```
...
ggsave("../../plots/baseline_NMR_pct_fat_6M_male.pdf",
       height = 1.8, width = 1.1, family = "ArialMT")
```
...
ggsave("../../plots/baseline_NMR_pct_fat_18M_female.pdf",
       height = 1.8, width = 1.1, family = "ArialMT")
```
...
ggsave("../../plots/baseline_NMR_pct_fat_18M_male.pdf",
       height = 1.8, width = 1.1, family = "ArialMT")
```
...
ggsave("../../plots/baseline_absolute_VO2max_6M_female.pdf",
       height = 1.8, width = 1.1, family = "ArialMT")
```
...
ggsave("../../plots/baseline_absolute_VO2max_6M_male.pdf",
       height = 1.8, width = 1.1, family = "ArialMT")
```
...
ggsave("../../plots/baseline_absolute_VO2max_18M_female.pdf",
       height = 1.8, width = 1, family = "ArialMT")
```
...
ggsave("../../plots/baseline_absolute_VO2max_18M_male.pdf",
       height = 1.8, width = 1, family = "ArialMT")
```
...
ggsave("../../plots/baseline_relative_VO2max_6M_female.pdf",
       height = 1.8, width = 1.1, family = "ArialMT")
```
...
ggsave("../../plots/baseline_relative_VO2max_6M_male.pdf",
       height = 1.8, width = 1.1, family = "ArialMT")
```
...
ggsave("../../plots/baseline_relative_VO2max_18M_female.pdf",
       height = 1.8, width = 1, family = "ArialMT")
```
...
ggsave("../../plots/baseline_relative_VO2max_18M_male.pdf",
       height = 1.8, width = 1, family = "ArialMT")
```
...
ggsave("../../plots/baseline_max_run_speed_6M_female.pdf",
       height = 1.8, width = 1.1, family = "ArialMT")
```
...
ggsave("../../plots/baseline_max_run_speed_6M_male.pdf",
       height = 1.8, width = 1.1, family = "ArialMT")
```
...
ggsave("../../plots/baseline_max_run_speed_18M_female.pdf",
...
ggsave("../../plots/baseline_max_run_speed_18M_male.pdf",
       height = 1.8, width = 1.2, family = "ArialMT")
```
