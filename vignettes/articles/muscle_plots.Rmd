...
ggsave("../../plots/muscle_glycogen_LG_6M_female.pdf",
...
ggsave("../../plots/muscle_glycogen_LG_6M_male.pdf",
       height = 1.8, width = 1.5, family = "ArialMT")
```
...
ggsave("../../plots/muscle_glycogen_LG_18M_female.pdf",
       height = 1.8, width = 1.5, family = "ArialMT")
```
...
ggsave("../../plots/muscle_glycogen_LG_18M_male.pdf",
       height = 1.8, width = 1.5, family = "ArialMT")
```
...
ggsave("../../plots/muscle_glycogen_MG_6M_female.pdf",
       height = 1.8, width = 1.5, family = "ArialMT")
```
...
ggsave("../../plots/muscle_glycogen_MG_6M_male.pdf",
       height = 1.8, width = 1.5, family = "ArialMT")
```
...
ggsave("../../plots/muscle_glycogen_MG_18M_female.pdf",
       height = 1.8, width = 1.5, family = "ArialMT")
```
...
ggsave("../../plots/muscle_glycogen_MG_18M_male.pdf",
       height = 1.8, width = 1.5, family = "ArialMT")
```
...
plot_baseline(x = filter(MUSCLES, muscle == "PL"), 
              ...
              stats = filter(MUSCLES_STATS, response == "Glycogen", 
                             muscle == "PL"),
              sex = "Female", age = "6M", y_position = 12) +
...
ggsave("../../plots/muscle_glycogen_PL_6M_female.pdf",
       height = 1.8, width = 1.5, family = "ArialMT")
```
...
ggsave("../../plots/muscle_glycogen_PL_6M_male.pdf",
       height = 1.8, width = 1.5, family = "ArialMT")
```
...
ggsave("../../plots/muscle_glycogen_PL_18M_female.pdf",
       height = 1.8, width = 1.5, family = "ArialMT")
```
...
ggsave("../../plots/muscle_glycogen_PL_18M_male.pdf",
       height = 1.8, width = 1.5, family = "ArialMT")
```
...
ggsave("../../plots/muscle_glycogen_SOL_6M_female.pdf",
       height = 1.8, width = 1.5, family = "ArialMT")
```
...
ggsave("../../plots/muscle_glycogen_SOL_6M_male.pdf",
       height = 1.8, width = 1.5, family = "ArialMT")
```
...
ggsave("../../plots/muscle_glycogen_SOL_18M_female.pdf",
       height = 1.8, width = 1.5, family = "ArialMT")
```
...
ggsave("../../plots/muscle_glycogen_SOL_18M_male.pdf",
       height = 1.8, width = 1.5, family = "ArialMT")
```
...
ggsave("../../plots/muscle_citrate_synthase_LG_6M_female.pdf",
       height = 1.8, width = 1.5, family = "ArialMT")
```
...
ggsave("../../plots/muscle_citrate_synthase_LG_6M_male.pdf",
       height = 1.8, width = 1.5, family = "ArialMT")
```
...
ggsave("../../plots/muscle_citrate_synthase_LG_18M_female.pdf",
       height = 1.8, width = 1.5, family = "ArialMT")
```
...
ggsave("../../plots/muscle_citrate_synthase_LG_18M_male.pdf",
       height = 1.8, width = 1.5, family = "ArialMT")
```
...
ggsave("../../plots/muscle_citrate_synthase_MG_6M_female.pdf",
       height = 1.8, width = 1.5, family = "ArialMT")
```
...
ggsave("../../plots/muscle_citrate_synthase_MG_6M_male.pdf",
       height = 1.8, width = 1.5, family = "ArialMT")
```
...
ggsave("../../plots/muscle_citrate_synthase_MG_18M_female.pdf",
       height = 1.8, width = 1.5, family = "ArialMT")
```
...
ggsave("../../plots/muscle_citrate_synthase_MG_18M_male.pdf",
       height = 1.8, width = 1.5, family = "ArialMT")
```
...
ggsave("../../plots/muscle_citrate_synthase_PL_6M_female.pdf",
       height = 1.8, width = 1.5, family = "ArialMT")
```
...
ggsave("../../plots/muscle_citrate_synthase_PL_6M_male.pdf",
       height = 1.8, width = 1.5, family = "ArialMT")
```
...
ggsave("../../plots/muscle_citrate_synthase_PL_18M_female.pdf",
       height = 1.8, width = 1.5, family = "ArialMT")
```
...
ggsave("../../plots/muscle_citrate_synthase_PL_18M_male.pdf",
       height = 1.8, width = 1.5, family = "ArialMT")
```
...
ggsave("../../plots/muscle_citrate_synthase_SOL_6M_female.pdf",
       height = 1.8, width = 1.5, family = "ArialMT")
```
...
ggsave("../../plots/muscle_citrate_synthase_SOL_6M_male.pdf",
       height = 1.8, width = 1.5, family = "ArialMT")
```
...
ggsave("../../plots/muscle_citrate_synthase_SOL_18M_female.pdf",
       height = 1.8, width = 1.5, family = "ArialMT")
```
...
ggsave("../../plots/muscle_citrate_synthase_SOL_18M_male.pdf",
       height = 1.8, width = 1.5, family = "ArialMT")
```
...
ggsave("../../plots/muscle_term_muscle_mass_LG_6M_female.pdf",
       height = 1.8, width = 1.5, family = "ArialMT")
```
...
ggsave("../../plots/muscle_term_muscle_mass_LG_6M_male.pdf",
       height = 1.8, width = 1.5, family = "ArialMT")
```
...
ggsave("../../plots/muscle_term_muscle_mass_LG_18M_female.pdf",
       height = 1.8, width = 1.5, family = "ArialMT")
```
...
ggsave("../../plots/muscle_term_muscle_mass_LG_18M_male.pdf",
       height = 1.8, width = 1.5, family = "ArialMT")
```
...
ggsave("../../plots/muscle_term_muscle_mass_MG_6M_female.pdf",
       height = 1.8, width = 1.5, family = "ArialMT")
```
...
ggsave("../../plots/muscle_term_muscle_mass_MG_6M_male.pdf",
       height = 1.8, width = 1.5, family = "ArialMT")
```
...
ggsave("../../plots/muscle_term_muscle_mass_MG_18M_female.pdf",
       height = 1.8, width = 1.5, family = "ArialMT")
```
...
ggsave("../../plots/muscle_term_muscle_mass_MG_18M_male.pdf",
       height = 1.8, width = 1.5, family = "ArialMT")
```
...
ggsave("../../plots/muscle_term_muscle_mass_PL_6M_female.pdf",
       height = 1.8, width = 1.5, family = "ArialMT")
```
...
ggsave("../../plots/muscle_term_muscle_mass_PL_6M_male.pdf",
       height = 1.8, width = 1.5, family = "ArialMT")
```
...
ggsave("../../plots/muscle_term_muscle_mass_PL_18M_female.pdf",
       height = 1.8, width = 1.5, family = "ArialMT")
```
...
ggsave("../../plots/muscle_term_muscle_mass_PL_18M_male.pdf",
       height = 1.8, width = 1.5, family = "ArialMT")
```
...
ggsave("../../plots/muscle_term_muscle_mass_SOL_6M_female.pdf",
       height = 1.8, width = 1.5, family = "ArialMT")
```
...
ggsave("../../plots/muscle_term_muscle_mass_SOL_6M_male.pdf",
       height = 1.8, width = 1.5, family = "ArialMT")
```
...
ggsave("../../plots/muscle_term_muscle_mass_SOL_18M_female.pdf",
       height = 1.8, width = 1.5, family = "ArialMT")
```
...
ggsave("../../plots/muscle_term_muscle_mass_SOL_18M_male.pdf",
       height = 1.8, width = 1.5, family = "ArialMT")
```
...
ggsave("../../plots/mean_CSA_6M_female.pdf", 
       height = 1.7, width = 2, family = "ArialMT")
```
...
ggsave("../../plots/mean_CSA_6M_male.pdf", 
       height = 1.7, width = 2, family = "ArialMT")
```
...
ggsave("../../plots/mean_CSA_18M_female.pdf", 
       height = 1.7, width = 2, family = "ArialMT")
```
...
ggsave("../../plots/mean_CSA_18M_male.pdf", 
       height = 1.7, width = 2, family = "ArialMT")
```
...
ggsave("../../plots/capillary_contacts_6M_female.pdf", 
       height = 1.7, width = 2, family = "ArialMT")
```
...
ggsave("../../plots/capillary_contacts_6M_male.pdf", 
       height = 1.7, width = 2, family = "ArialMT")
```
...
ggsave("../../plots/capillary_contacts_18M_female.pdf", 
       height = 1.7, width = 2, family = "ArialMT")
```
...
ggsave("../../plots/capillary_contacts_18M_male.pdf", 
       height = 1.7, width = 2, family = "ArialMT")
```
