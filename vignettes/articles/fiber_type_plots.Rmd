...
ggsave(filename = "../../plots/fiber_CSA_LG_6M_female.pdf", 
...
ggsave(filename = "../../plots/fiber_CSA_LG_6M_male.pdf", 
       height = 1.7, width = 1.4, family = "ArialMT")
```
...
ggsave(filename = "../../plots/fiber_CSA_LG_18M_female.pdf", 
       height = 1.7, width = 1.4, family = "ArialMT")
```
...
ggsave(filename = "../../plots/fiber_CSA_LG_18M_male.pdf", 
       height = 1.7, width = 1.4, family = "ArialMT")
```
...
ggsave(filename = "../../plots/fiber_CSA_MG_6M_female.pdf", 
       height = 1.7, width = 1.4, family = "ArialMT")
```
...
ggsave(filename = "../../plots/fiber_CSA_MG_6M_male.pdf", 
       height = 1.7, width = 1.4, family = "ArialMT")
```
...
ggsave(filename = "../../plots/fiber_CSA_MG_18M_female.pdf", 
       height = 1.7, width = 1.4, family = "ArialMT")
```
...
ggsave(filename = "../../plots/fiber_CSA_MG_18M_male.pdf", 
       height = 1.7, width = 1.4, family = "ArialMT")
```
...
ggsave(filename = "../../plots/fiber_CSA_PL_6M_female.pdf", 
       height = 1.7, width = 1.4, family = "ArialMT")
```
...
ggsave(filename = "../../plots/fiber_CSA_PL_6M_male.pdf", 
       height = 1.7, width = 1.4, family = "ArialMT")
```
...
ggsave(filename = "../../plots/fiber_CSA_PL_18M_female.pdf", 
       height = 1.7, width = 1.4, family = "ArialMT")
```
...
ggsave(filename = "../../plots/fiber_CSA_PL_18M_male.pdf", 
       height = 1.7, width = 1.4, family = "ArialMT")
```
...
ggsave(filename = "../../plots/fiber_CSA_SOL_6M_female.pdf", 
...
ggsave(filename = "../../plots/fiber_CSA_SOL_6M_male.pdf", 
       height = 1.7, width = 1.2, family = "ArialMT")
```
...
ggsave(filename = "../../plots/fiber_CSA_SOL_18M_female.pdf",
       height = 1.7, width = 1.2, family = "ArialMT")
```
...
ggsave(filename = "../../plots/fiber_CSA_SOL_18M_male.pdf", 
       height = 1.7, width = 1.2, family = "ArialMT")
```
